		...
		var algorithmForm = {
			...
			startAlgorithmButton: {
				click: () => {
					...
					console.log("DEBUG HALP PLS!",user().userName, selectedAlgorithm().value, algorithmParamObservables());
